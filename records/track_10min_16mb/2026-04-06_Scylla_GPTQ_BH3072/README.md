...
- **Scylla tokenizer** (998-vocab TokenMonster, PR #1143 @simon-marcus): 37% fewer tokens per byte vs SentencePiece 1024. **Note:** uses pre-correction metadata from PR #1143 (superseded); see PR #1314 for byte-exact 1254-vocab rebuild
...
- No n-gram cache
- No network calls
- Tokenizer byte accounting via metadata (candidate.meta.npz) — **pending revalidation** against PR #1314 byte-exact audit
