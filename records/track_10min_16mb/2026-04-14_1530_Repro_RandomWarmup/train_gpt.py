...
def train_and_eval(h, device):
    ...
    if h.ttt_enabled:
        ...
        if _ttt_debug_bypass:
            ...
            if BOS_ID is None:
                BOS_ID = 1
            # Random-token compile warmup (no validation data leakage).
            # Shapes drive torch.compile recompilation, not contents -- random
            # int64 tokens of identical shape produce the same compile cache.
